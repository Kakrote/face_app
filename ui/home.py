...
class DetailFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        super().__init__(master, width=400,height=600, fg_color="pink",**kwargs)
        # self.scroll=ctk.CTkScrollableFrame(self,width=400,height=800)
        # self.scroll.pack(expand=True,fill=tkinter.BOTH)
        self.title=ctk.CTkLabel(self,text="Details will be display over here ",font=("times new roman",20),text_color="#333",fg_color="yellow",anchor="center")
    ...
    def show(self):
        ...
        self.grid(row=1,column=1,sticky='ne',padx=10,pady=10)
# live camera frame 
class LiveCamera(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        super().__init__(master, width=500, height=500,corner_radius=12,border_color="white",fg_color="yellow",border_width=2, **kwargs)
        self.title=ctk.CTkLabel(self,text="live camera",font=("times new roman",20),fg_color="white",text_color='#333',anchor='center')
    ...
    def show(self):
        ...
        self.b_start.grid(row=1,column=0,padx=10,pady=10,sticky="w")


        self.grid(row=1,column=0,padx=10,pady=10,sticky='nw')
